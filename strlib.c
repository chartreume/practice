 ...
 * functions into the approprite calls to the <string.h>
...
{
    if( s == NULL ) Error("NULL string passed to StringLenght");
    return ( strlen( s ) );
}
 ...
 * --------------
 * This function dynamically alloacates space for a string of
