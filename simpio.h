 ...
 * integer connot be scanned or if more characters follor the
 ...
 * If an integer connot be scanned or if more characters follow
 ...
 * it as a double.  If the number connot be scanned or if extra
 ...
 * string. The ReadLine function returns NULL if inline
